...
# 1) SET THESE PATHS:
OPENFDA_GRAPHML = "drug_data_kg_openfda_edges_no_drop.graphml"        # <-- change to your file
HETIONET_GRAPHML = "hetionet_normalized.graphml"      # <-- change to your file
OUTDIR = "merged_ofda_hetionet"            # <-- change if you like
...
pickle_path = "merged_ofda_hetionet/combined_openfda_hetionet.pkl"  # <- change if needed

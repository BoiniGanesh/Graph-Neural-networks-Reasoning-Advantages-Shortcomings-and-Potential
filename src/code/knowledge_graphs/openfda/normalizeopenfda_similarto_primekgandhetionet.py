...
GRAPH_PATH = "drug_data_kg_rebuilt_normalized.graphml"
...
# ==========================
INPUT_PATH  = "drug_data_kg_rebuilt_normalized.graphml"   # your normalized OpenFDA graph
OUTPUT_PATH = "drug_data_kg_rebuilt_nodes_normalized.graphml"           # output
...
# ==========================
INPUT_PATH  = "drug_data_kg_rebuilt_normalized.graphml"   # your normalized OpenFDA graph
OUTPUT_PATH = "drug_data_kg_rebuilt_openfda_nodes_renamed.graphml"             # where to save the node-renamed graph
...
# ---------- CONFIG ----------
GRAPH_IN  = "drug_data_kg_rebuilt_openfda_nodes_renamed.graphml"
GRAPH_OUT = "drug_data_kg_openfda_edges_renamed.graphml"
...
G = nx.read_graphml("drug_data_kg_openfda_edges_renamed.graphml")
...
# --- paths ---
IN_PATH  = "drug_data_kg_openfda_edges_renamed.graphml"
OUT_PATH = "drug_data_kg_openfda_edges_renamed_clean.graphml"
...
# --- Load GraphML ---
path = "drug_data_kg_openfda_edges_renamed_clean.graphml"
...
GRAPH_PATH = "drug_data_kg_openfda_edges_renamed_clean.graphml"
G = nx.read_graphml(GRAPH_PATH)
...
# --- CONFIG ---
GRAPH_PATH = "drug_data_kg_openfda_edges_renamed_clean.graphml"
OUT_PATH   = Path("drug_data_kg_openfda_edges_minimal.graphml")
...
G = nx.read_graphml("drug_data_kg_openfda_edges_minimal.graphml")  # or IN_PATH if you kept metaedge
triplets = Counter(
...
# === CONFIG ===
IN_PATH  = "drug_data_kg_openfda_edges_minimal.graphml"
OUT_PATH = "drug_data_kg_openfda_edges_no_drop.graphml"
...
# --- CONFIG ---
GRAPH_PATH = "drug_data_kg_openfda_edges_no_drop.graphml"
...
G = nx.read_graphml("drug_data_kg_openfda_edges_no_drop.graphml")  # or IN_PATH if you kept metaedge
triplets = Counter(
    (G.nodes[u]["node_type"], a.get("relation"), G.nodes[v]["node_type"])
    for u, v, a in G.edges(data=True)
)
